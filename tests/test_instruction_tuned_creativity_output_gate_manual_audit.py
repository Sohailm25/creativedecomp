# ABOUTME: Verifies the cached instruction-tuned creativity manual audit stays deterministic, blinded, and comparison-safe.
# ABOUTME: Prevents the matched creativity continuation from relying on opaque cached-output inspection after the automatic judge collapses.
...
SCRIPT_PATH = ROOT / "scripts" / "audit_instruction_tuned_creativity_output_gate_v1.py"


def load_audit_module():
    spec = importlib.util.spec_from_file_location(
        "audit_instruction_tuned_creativity_output_gate_v1",
        SCRIPT_PATH,
    )
...
class InstructionTunedCreativityOutputGateManualAuditTest(unittest.TestCase):
    def test_resolve_candidate_condition_ids_excludes_reference_and_sorts(self) -> None:
        audit = load_audit_module()

        output_rows = [
            {"condition_id": "neutral_steered_layer12_coeff_1p0"},
            {"condition_id": "neutral_unsteered"},
            {"condition_id": "creative_prompt_unsteered"},
            {"condition_id": "neutral_steered_layer12_coeff_0p5"},
        ]
    ...
    def test_build_blinded_audit_rows_creates_one_row_per_prompt_comparison(self) -> None:
        ...
        output_rows = [
            ...
            },
            {
                ...
                "prompt_text": "A lighthouse swallows the moon.",
                "condition_id": "creative_prompt_unsteered",
                "completion_text": "Creative output 1",
            },
            {
                "prompt_id": "p1",
                "prompt_text": "A lighthouse swallows the moon.",
            ...
            },
            {
                ...
                "prompt_text": "A ship writes letters to the harbor.",
                "condition_id": "creative_prompt_unsteered",
                "completion_text": "Creative output 2",
            },
            {
                "prompt_id": "p2",
                "prompt_text": "A ship writes letters to the harbor.",
        ...
        self.assertEqual(
            {
                ...
                "neutral_steered_layer12_coeff_0p5_vs_neutral_unsteered",
            },
    ...
    def test_summarize_manual_annotations_reports_per_comparison_fractions(self) -> None:
        ...
        answer_key_rows = [
            ...
            },
            {
                ...
                "comparison_id": "neutral_steered_layer12_coeff_0p5_vs_neutral_unsteered",
                "candidate_condition_id": "neutral_steered_layer12_coeff_0p5",
                "reference_condition_id": "neutral_unsteered",
                "story_a_condition_id": "neutral_steered_layer12_coeff_0p5",
                "story_b_condition_id": "neutral_unsteered",
            },
            {
                ...
                "reference_condition_id": "neutral_unsteered",
                "story_a_condition_id": "neutral_unsteered",
                "story_b_condition_id": "neutral_steered_layer12_coeff_0p5",
            },
        ]
        annotation_rows = [
            {
            ...
            {
                "audit_pair_id": "pair-3",
                "prompt_grounded_creativity_winner_label": "tie",
                "coherence_winner_label": "A",
            },
            {
                "audit_pair_id": "pair-4",
        ...
        creativity_baseline = comparison_rows["creative_prompt_unsteered_vs_neutral_unsteered"]
        dense_control = comparison_rows["neutral_steered_layer12_coeff_0p5_vs_neutral_unsteered"]

        self.assertEqual(4, summary["sample_count"])
        self.assertEqual(2, creativity_baseline["sample_count"])
        self.assertEqual(1.0, creativity_baseline["prompt_grounded_creativity_candidate_win_fraction"])
        self.assertEqual(0.0, creativity_baseline["coherence_candidate_win_fraction"])
        self.assertEqual(0.5, creativity_baseline["coherence_reference_win_fraction"])
        self.assertEqual(0.5, dense_control["prompt_grounded_creativity_reference_win_fraction"])
        self.assertEqual(0.5, dense_control["prompt_grounded_creativity_tie_fraction"])
